...
const MTechSem1Registrations = () => {
  ...
  const loadRegistrations = async () => {
    try {
      setLoading(true);
      const response = await adminAPI.getMTechSem1Registrations();
      setRegistrations(response.data || []);
    } catch (error) {
      console.error('Failed to load M.Tech Sem 1 registrations:', error);
  ...
  const exportCsv = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'mtech_sem1_minor_project_registrations.csv');
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">M.Tech Sem 1 Minor Project Registrations</h1>
            <p className="mt-2 text-gray-600">
              Track registrations and allocations for the current M.Tech Semester 1 Minor Project 1 cycle.
            </p>
          </div>
          <Link
            to="/dashboard/admin"
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="flex items-end">
              <button
                ...
                className="w-full md:w-auto bg-rose-600 hover:bg-rose-700 text-white px-4 py-2 rounded-md transition"
              >
                Refresh
              </button>
            </div>
        ...
        <div className="grid gap-4 md:grid-cols-4 mb-6">
          <div className="bg-gradient-to-r from-rose-500 to-pink-500 text-white rounded-lg p-4 shadow">
...
export default MTechSem1Registrations;
